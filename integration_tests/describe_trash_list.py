...
from .files import (make_empty_file, make_parent_for, make_sticky_dir, make_unreadable_file, make_unsticky_dir,
                    require_empty_dir, write_file)
from .output_collector import OutputCollector
from .trashinfo import (a_trashinfo, a_trashinfo_with_invalid_date, a_trashinfo_without_date, a_trashinfo_without_path)
...
class FakeTrashDir:
    ...
    def having_file(self, contents):
        path = f'{self.path}/{str(self.number)}.trashinfo'
