...
from nose.tools import assert_equals, assert_raises, istest
...
class describe_maybe_parse_deletion_date:
    ...
    def on_trashinfo_with_date_parse_to_date(self):
        ...
        assert_equals(same_date_as_datetime, maybe_parse_deletion_date(make_trashinfo(example_date_as_string)))
